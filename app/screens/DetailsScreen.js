    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <View style={styles.informacion}>
          ...
          <View style={[styles.bordes]}>
            <Text style={{textAlign:'center', paddingVertical:'3%'}}>C.I: {info.ci}</Text>
          </View>
          <View style={[styles.bordes ,{borderBottomWidth:0.2, borderBottomColor:'#000'}]}>
            <Text style={{textAlign:'center', paddingVertical:'3%'}}>Fecha de Nacimiento: {info.fecha_nac}</Text>
          </View>
          <View style={[styles.bordes]}>
            <Text style={{textAlign:'center', paddingVertical:'3%'}}>Tipo de Sangre: {info.tipo_sangre}</Text>
          </View>
          <View style={[styles.bordes]}>
